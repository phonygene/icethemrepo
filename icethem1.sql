...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(7,'user','user');
...
CREATE TABLE `foods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fridgeid` int(11) DEFAULT NULL,
  `foodname` varchar(45) COLLATE utf8mb4_czech_ci NOT NULL,
  `foodtype` varchar(45) COLLATE utf8mb4_czech_ci DEFAULT NULL,
  `iceddate` datetime NOT NULL,
  `expiredate` datetime DEFAULT NULL,
  `foodimg` varchar(45) COLLATE utf8mb4_czech_ci DEFAULT NULL,
  `description` varchar(500) COLLATE utf8mb4_czech_ci DEFAULT NULL,
  `foodid` varchar(45) COLLATE utf8mb4_czech_ci DEFAULT NULL,
  `amount` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fridge_id_idx` (`fridgeid`),
  CONSTRAINT `fridge_id` FOREIGN KEY (`fridgeid`) REFERENCES `ice'em`.`fridge` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `foods` VALUES (6,NULL,'香蕉','fruits','2018-01-13 00:00:00','2018-01-20 00:00:00','banana.jpg','banana bad',NULL,NULL),(7,NULL,'蘋果','fruits','2018-01-09 00:00:00','2018-01-22 00:00:00','apple.jpg','mac',NULL,NULL),(8,NULL,'西瓜','fruit','2018-01-16 00:00:00','2018-01-22 00:00:00','melon.jpg','假的',NULL,NULL);
...
CREATE TABLE `fridge` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fridgeid` varchar(45) COLLATE utf8_czech_ci NOT NULL,
  `fridgename` varchar(45) COLLATE utf8_czech_ci NOT NULL,
  `stacks` varchar(45) COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`,`fridgeid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `useremail` varchar(100) COLLATE utf8_czech_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-29 18:12:22
